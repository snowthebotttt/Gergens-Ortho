...
const prescriptionSchema = yup.object({
  ...
  applianceDetails: yup.object().when('applianceType', {
    is: (val: string) => val === 'sleep',
    then: yup.object({
      sleepApplianceType: yup.string().required('Please select a sleep appliance type'),
    }),
    otherwise: yup.object().nullable(),
  }),
  instructions: yup.string(),
  rushOrder: yup.boolean(),
  deliveryDate: yup.date().nullable().min(new Date(), 'Delivery date cannot be in the past'),
});
    ...
    switch (step) {
      case 1:
        return (
          ...
          >
            <h3 className="text-lg font-medium text-gray-900 mb-6">Doctor & Patient Information</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <input
                  ...
                  id="doctorName"
                  {...register('doctorName')}
                  className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${errors.doctorName ? 'border-red-300' : ''}`}
                />
                {errors.doctorName && (
              ...
              <div>
                ...
                <input
                  ...
                  id="practice"
                  {...register('practice')}
                  className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${errors.practice ? 'border-red-300' : ''}`}
                />
                {errors.practice && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  id="phone"
                  {...register('phone')}
                  className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${errors.phone ? 'border-red-300' : ''}`}
                />
                {errors.phone && (
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${errors.patientIdentifier ? 'border-red-300' : ''}`}
              />
              {errors.patientIdentifier && (
                <p className="mt-1 text-sm text-red-600">{errors.patientIdentifier.message}</p>
              )}
              <p className="mt-1 text-xs text-gray-500">
                For patient privacy, you may use an identifier instead of a full name
              </p>
            </div>
          </motion.div>
        );
      ...
      case 2:
        return (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <h3 className="text-lg font-medium text-gray-900 mb-6">Appliance Selection</h3>
                  ...
                  render={({ field }) => (
                    <select
                      ...
                      className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${
                        errors.applianceDetails?.sleepApplianceType ? 'border-red-300' : ''
                      }`}
                    >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm ${errors.deliveryDate ? 'border-red-300' : ''}`}
                />
                {errors.deliveryDate && (
      ...
      case 3:
        return (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <h3 className="text-lg font-medium text-gray-900 mb-6">File Upload</h3>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    Please ensure all files are correctly named and formatted. For STL files, please include both upper and lower arches if applicable.
                  </p>
                </div>
              </div>
            </div>
        ...
        return (
          ...
          >
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              <h4 className="text-md font-medium text-gray-900 mb-4">Case Summary</h4>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                  <h5 className="text-sm font-medium text-gray-700">Doctor Information</h5>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-1">{watch('patientIdentifier')}</p>
                </div>
              </div>
              
              <div className="mb-6">
                <h5 className="text-sm font-medium text-gray-700">Appliance Details</h5>
                <div className="mt-1">
                  ...
                  {applianceType === 'sleep' && watch('applianceDetails.sleepApplianceType') && (
                    <p className="text-sm text-gray-900">
                      <span className="font-medium">Type:</span>{' '}
                      {watch('applianceDetails.sleepApplianceType') === 'dorsal' && 'Dorsal Appliance'}
                      {watch('applianceDetails.sleepApplianceType') === 'ema' && 'EMA Device'}
                      {watch('applianceDetails.sleepApplianceType') === 'herbst' && 'Herbst Appliance'}
                      {watch('applianceDetails.sleepApplianceType') === 'tap' && 'TAP Appliance'}
                      {watch('applianceDetails.sleepApplianceType') === 'somnodent' && 'SomnoDent'}
                      {watch('applianceDetails.sleepApplianceType') === 'custom' && 'Custom Design'}
                    </p>
                  )}
                  ...
                  {watch('instructions') && (
                    <div className="mt-2">
                      ...
                      <p className="text-sm text-gray-900 mt-1">{watch('instructions')}</p>
                    </div>
                  )}
                  
                  {watch('rushOrder') && (
                    <p className="text-sm text-red-600 mt-2">Rush Order Requested</p>
                  )}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    By submitting this form, you agree to our terms of service and privacy policy. You will receive a confirmation email with your case details.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your case has been submitted to Gergen's Orthodontic Lab. You will receive a confirmation email shortly with your case details and tracking information.
          </p>
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div className="px-4 py-5 sm:p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Submit a New Case</h2>
